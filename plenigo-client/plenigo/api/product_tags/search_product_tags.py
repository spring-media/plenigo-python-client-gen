...
) -> Optional[Union[ErrorResult, ErrorResultBase, ProductTags]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResult, ErrorResultBase, ProductTags]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResult, ErrorResultBase, ProductTags]
    """
