...
def _get_kwargs(
    *,
    ...
    url = "{}/products/productTags".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorResultBase, ProductTags]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ProductTags.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorResultBase, ProductTags]]:
    return Response(
...
def sync_all(
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Optional[Union[ErrorResultBase, ProductTags]]:
    all_results = ProductTags(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Response[Union[ErrorResultBase, ProductTags]]:
    """Search
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResultBase, ProductTags]
    """
