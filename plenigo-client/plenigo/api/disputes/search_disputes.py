...
from ...models.search_disputes_status import SearchDisputesStatus
...
def _get_kwargs(
    *,
    ...
    status: Union[Unset, SearchDisputesStatus] = UNSET,
...
) -> Optional[Union[Disputes, ErrorResultBase]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = Disputes.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Disputes, ErrorResultBase]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        status (Union[Unset, SearchDisputesStatus]):
...
def sync(
    *,
    ...
    Returns:
        Union[Disputes, ErrorResultBase]
    """
