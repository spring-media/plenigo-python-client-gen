...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/mails/logs/{mailLogEntryId}".format(client.api.value, mailLogEntryId=mail_log_entry_id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorResultBase, MailLogEntry]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorResultBase, MailLogEntry]]:
    return Response(
