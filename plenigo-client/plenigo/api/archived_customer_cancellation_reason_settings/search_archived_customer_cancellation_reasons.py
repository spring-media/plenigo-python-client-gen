...
def _get_kwargs(
    *,
    ...
    url = "{}/settings/customerCancellationReasons/archived".format(client.api.value)
...
) -> Optional[Union[CustomerCancellationReasons, ErrorResultBase]]:
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[CustomerCancellationReasons, ErrorResultBase]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[CustomerCancellationReasons, ErrorResultBase]
    """
