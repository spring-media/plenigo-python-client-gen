...
from ...models.search_tax_codes_sort import SearchTaxCodesSort
from ...models.tax_codes import TaxCodes
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchTaxCodesSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/accounting/taxCodes".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorResultBase, TaxCodes]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = TaxCodes.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorResultBase, TaxCodes]]:
    return Response(
...
def sync_all(
    *,
    ...
    ending_before: Union[Unset, None, str] = UNSET,
    sort: Union[Unset, None, SearchTaxCodesSort] = UNSET,
) -> Optional[Union[ErrorResultBase, TaxCodes]]:
    all_results = TaxCodes(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    ending_before: Union[Unset, None, str] = UNSET,
    sort: Union[Unset, None, SearchTaxCodesSort] = UNSET,
) -> Response[Union[ErrorResultBase, TaxCodes]]:
    """Search tax codes
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchTaxCodesSort]):
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResultBase, TaxCodes]
    """
