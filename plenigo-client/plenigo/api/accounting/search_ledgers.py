...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchLedgersSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/accounting/ledgers".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorResultBase, Ledgers]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorResultBase, Ledgers]]:
    return Response(
...
def sync_all(
    *,
    ...
    all_results = Ledgers(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchLedgersSort]):
