...
from ...models.cost_centers import CostCenters
from ...models.error_result_base import ErrorResultBase
from ...models.search_cost_centers_sort import SearchCostCentersSort
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchCostCentersSort] = UNSET,
) -> Dict[str, Any]:
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[CostCenters, ErrorResultBase]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = CostCenters.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[CostCenters, ErrorResultBase]]:
    return Response(
...
def sync_all(
    *,
    ...
    ending_before: Union[Unset, None, str] = UNSET,
    sort: Union[Unset, None, SearchCostCentersSort] = UNSET,
) -> Optional[Union[CostCenters, ErrorResultBase]]:
    all_results = CostCenters(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    ending_before: Union[Unset, None, str] = UNSET,
    sort: Union[Unset, None, SearchCostCentersSort] = UNSET,
) -> Response[Union[CostCenters, ErrorResultBase]]:
    """Search cost centers
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchCostCentersSort]):
...
def sync(
    *,
    ...
    Returns:
        Union[CostCenters, ErrorResultBase]
    """
