...
from ...models.product_ivw_rules import ProductIvwRules
...
def _get_kwargs(
    *,
    ...
    url = "{}/products/ivwRules".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorResultBase, ProductIvwRules]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ProductIvwRules.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorResultBase, ProductIvwRules]]:
    return Response(
...
def sync_all(
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Optional[Union[ErrorResultBase, ProductIvwRules]]:
    all_results = ProductIvwRules(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Response[Union[ErrorResultBase, ProductIvwRules]]:
    """Search
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResultBase, ProductIvwRules]
    """
