...
) -> Optional[Union[ErrorResult, ErrorResultBase, ProductIvwRules]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResult, ErrorResultBase, ProductIvwRules]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResult, ErrorResultBase, ProductIvwRules]
    """
