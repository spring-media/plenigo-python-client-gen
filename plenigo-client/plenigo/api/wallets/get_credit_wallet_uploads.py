...
from ...models.get_credit_wallet_uploads_sort import GetCreditWalletUploadsSort
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, GetCreditWalletUploadsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/wallets/creditsUploaded".format(client.api.value)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (Union[Unset, None, GetCreditWalletUploadsSort]):
