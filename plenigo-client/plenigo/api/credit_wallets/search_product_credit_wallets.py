...
) -> Optional[Union[CreditWallets, ErrorResult, ErrorResultBase]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CreditWallets, ErrorResult, ErrorResultBase]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[CreditWallets, ErrorResult, ErrorResultBase]
    """
