...
from ...models.credit_wallets import CreditWallets
...
def _get_kwargs(
    *,
    ...
    url = "{}/products/creditWallets".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[CreditWallets, ErrorResultBase]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = CreditWallets.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[CreditWallets, ErrorResultBase]]:
    return Response(
...
def sync_all(
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Optional[Union[CreditWallets, ErrorResultBase]]:
    all_results = CreditWallets(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Response[Union[CreditWallets, ErrorResultBase]]:
...
def sync(
    *,
    ...
    Returns:
        Union[CreditWallets, ErrorResultBase]
    """
