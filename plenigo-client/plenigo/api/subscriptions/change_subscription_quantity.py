...
from ...models.subscription_item_change_quantity import SubscriptionItemChangeQuantity
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: SubscriptionItemChangeQuantity,
) -> Dict[str, Any]:
    url = "{}/subscriptions/{subscriptionId}/quantity".format(client.api.value, subscriptionId=subscription_id)
