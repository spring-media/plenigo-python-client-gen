...
from ...models.subscription_delivery_addition import SubscriptionDeliveryAddition


def _get_kwargs(
    subscription_id: int,
    *,
    body: SubscriptionDeliveryAddition,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "put",
        "url": f"/subscriptions/{subscription_id}/addDeliveries",
    }
