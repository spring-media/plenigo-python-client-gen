...
from ...models.search_subscription_ivw_records_sort import SearchSubscriptionIvwRecordsSort
from ...models.subscription_ivw_records import SubscriptionIvwRecords
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchSubscriptionIvwRecordsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/subscriptions/ivwRecords".format(client.api.value)
...
) -> Optional[Union[ErrorResultBase, SubscriptionIvwRecords]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = SubscriptionIvwRecords.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[ErrorResultBase, SubscriptionIvwRecords]]:
    return Response(
...
def sync_all(
    *,
    ...
    all_results = SubscriptionIvwRecords(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    r"""Search subscription IVW records
    ...
    Search all subscription IVW records that correspond to the given search conditions.
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchSubscriptionIvwRecordsSort]):
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResultBase, SubscriptionIvwRecords]
    """
