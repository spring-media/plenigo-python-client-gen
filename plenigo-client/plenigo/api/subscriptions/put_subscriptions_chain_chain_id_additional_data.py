...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: AdditionalChainData,
) -> Dict[str, Any]:
    url = "{}/subscriptions/chain/{chainId}/additionalData".format(client.api.value, chainId=chain_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Replace additional chain data
     ...
     Replace additional data of a subscription chain. All data will be replaced with the new data
    provided.
