...
from ...models.subscription_change_access import SubscriptionChangeAccess
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: SubscriptionChangeAccess,
) -> Dict[str, Any]:
    url = "{}/subscriptions/{subscriptionId}/access".format(client.api.value, subscriptionId=subscription_id)
