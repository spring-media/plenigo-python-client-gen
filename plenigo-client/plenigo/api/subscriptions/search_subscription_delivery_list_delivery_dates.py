...
from ...models.search_subscription_delivery_list_delivery_dates_sort import (
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, SearchSubscriptionDeliveryListDeliveryDatesSort] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/subscriptions/deliveryLists/dates",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (Union[Unset, SearchSubscriptionDeliveryListDeliveryDatesSort]):
