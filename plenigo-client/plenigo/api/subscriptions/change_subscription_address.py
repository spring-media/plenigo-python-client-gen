...
from ...models.subscription_change_address import SubscriptionChangeAddress
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: SubscriptionChangeAddress,
) -> Dict[str, Any]:
    url = "{}/subscriptions/{subscriptionId}/address".format(client.api.value, subscriptionId=subscription_id)
