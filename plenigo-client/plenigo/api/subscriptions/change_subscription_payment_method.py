...
from ...models.subscription_change_payment import SubscriptionChangePayment
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: SubscriptionChangePayment,
) -> Dict[str, Any]:
    url = "{}/subscriptions/{subscriptionId}/payment".format(client.api.value, subscriptionId=subscription_id)
