...
from ...models.subscription_change_suppress_invoice_sending import SubscriptionChangeSuppressInvoiceSending
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: SubscriptionChangeSuppressInvoiceSending,
) -> Dict[str, Any]:
    url = "{}/subscriptions/{subscriptionId}/suppressInvoiceSending".format(
        client.api.value, subscriptionId=subscription_id
    )
