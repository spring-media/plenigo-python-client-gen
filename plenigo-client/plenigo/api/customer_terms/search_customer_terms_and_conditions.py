...
) -> Optional[Union[CustomerTerms, ErrorResult, ErrorResultBase]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CustomerTerms, ErrorResult, ErrorResultBase]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[CustomerTerms, ErrorResult, ErrorResultBase]
    """
