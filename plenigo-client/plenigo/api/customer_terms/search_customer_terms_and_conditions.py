...
from ...models.customer_terms import CustomerTerms
...
def _get_kwargs(
    *,
    ...
    url = "{}/settings/termsAndConditions".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[CustomerTerms, ErrorResultBase]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = CustomerTerms.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[CustomerTerms, ErrorResultBase]]:
    return Response(
...
def sync_all(
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Optional[Union[CustomerTerms, ErrorResultBase]]:
    all_results = CustomerTerms(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Response[Union[CustomerTerms, ErrorResultBase]]:
    """Search terms and conditions

     Search all terms and conditionss that correspond to the given search conditions.
...
def sync(
    *,
    ...
    Returns:
        Union[CustomerTerms, ErrorResultBase]
    """
