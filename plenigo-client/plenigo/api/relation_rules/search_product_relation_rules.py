...
from ...models.relation_rules import RelationRules
...
def _get_kwargs(
    *,
    ...
    url = "{}/products/relationRules".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorResultBase, RelationRules]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = RelationRules.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorResultBase, RelationRules]]:
    return Response(
...
def sync_all(
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Optional[Union[ErrorResultBase, RelationRules]]:
    all_results = RelationRules(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Response[Union[ErrorResultBase, RelationRules]]:
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResultBase, RelationRules]
    """
