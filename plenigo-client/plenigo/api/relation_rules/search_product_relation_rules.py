...
) -> Optional[Union[ErrorResult, ErrorResultBase, RelationRules]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResult, ErrorResultBase, RelationRules]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResult, ErrorResultBase, RelationRules]
    """
