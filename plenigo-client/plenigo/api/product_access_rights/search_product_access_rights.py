...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchProductAccessRightsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/products/accessRights".format(client.api.value)
...
) -> Optional[Union[ErrorResultBase, ProductAccessRights]]:
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[ErrorResultBase, ProductAccessRights]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchProductAccessRightsSort]):
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResultBase, ProductAccessRights]
    """
