...
def _get_kwargs(
    *,
    ...
    url = "{}/products/appStoreOffers".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[AppStoreOffers, ErrorResultBase]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[AppStoreOffers, ErrorResultBase]]:
    return Response(
...
def sync_all(
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Optional[Union[AppStoreOffers, ErrorResultBase]]:
    all_results = AppStoreOffers(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Response[Union[AppStoreOffers, ErrorResultBase]]:
    """Search

     Search all app store offers that correspond to the given search conditions.
...
def sync(
    *,
    ...
    Returns:
        Union[AppStoreOffers, ErrorResultBase]
    """
