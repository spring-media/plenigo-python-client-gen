...
def _get_kwargs(
    *,
    ...
    json_body: CustomerSessionToken,
) -> Dict[str, Any]:
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorResultBase, TransferToken]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorResultBase, TransferToken]]:
    return Response(
...
def sync_detailed(
    *,
    client: AuthenticatedClient,
    json_body: CustomerSessionToken,
) -> Response[Union[ErrorResultBase, TransferToken]]:
...
def sync(
    *,
    client: AuthenticatedClient,
    json_body: CustomerSessionToken,
) -> Optional[Union[ErrorResultBase, TransferToken]]:
    """Create Transfer Token
    ...
    Returns:
        Union[ErrorResultBase, TransferToken]
    """
