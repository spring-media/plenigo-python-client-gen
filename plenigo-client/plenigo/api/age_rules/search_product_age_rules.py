...
from ...models.age_rules import AgeRules
...
def _get_kwargs(
    *,
    ...
    url = "{}/products/ageRules".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[AgeRules, ErrorResultBase]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = AgeRules.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[AgeRules, ErrorResultBase]]:
    return Response(
...
def sync_all(
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Optional[Union[AgeRules, ErrorResultBase]]:
    all_results = AgeRules(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Response[Union[AgeRules, ErrorResultBase]]:
    """Search age rules
...
def sync(
    *,
    ...
    Returns:
        Union[AgeRules, ErrorResultBase]
    """
