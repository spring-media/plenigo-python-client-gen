...
from ...models.cross_sellings import CrossSellings
...
def _get_kwargs(
    *,
    ...
    url = "{}/products/crossSellings".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[CrossSellings, ErrorResultBase]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = CrossSellings.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[CrossSellings, ErrorResultBase]]:
    return Response(
...
def sync_all(
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Optional[Union[CrossSellings, ErrorResultBase]]:
    all_results = CrossSellings(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Response[Union[CrossSellings, ErrorResultBase]]:
    """Search
...
def sync(
    *,
    ...
    Returns:
        Union[CrossSellings, ErrorResultBase]
    """
