...
) -> Optional[Union[CrossSellings, ErrorResult, ErrorResultBase]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CrossSellings, ErrorResult, ErrorResultBase]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[CrossSellings, ErrorResult, ErrorResultBase]
    """
