...
from ...models.customer_two_factor_authentication import CustomerTwoFactorAuthentication
...
def _get_kwargs(
    *,
    client: Client,
    json_body: CustomerTwoFactorAuthentication,
) -> Dict[str, Any]:
    url = "{}/processes/login/verifyTwoFactorAuth".format(client.api.value)
