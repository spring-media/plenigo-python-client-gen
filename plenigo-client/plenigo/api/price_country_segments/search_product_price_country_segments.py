...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchProductPriceCountrySegmentsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/products/priceCountrySegments".format(client.api.value)
...
) -> Optional[Union[ErrorResultBase, PriceCountrySegments]]:
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[ErrorResultBase, PriceCountrySegments]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchProductPriceCountrySegmentsSort]):
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResultBase, PriceCountrySegments]
    """
