...
def _get_kwargs(
    *,
    ...
    url = "{}/settings/advertisementOptIns".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[CustomerOptIns, ErrorResultBase]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[CustomerOptIns, ErrorResultBase]]:
    return Response(
...
def sync_all(
    *,
    ...
    all_results = CustomerOptIns(items=[])  # type: ignore
