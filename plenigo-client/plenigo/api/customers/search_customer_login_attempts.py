...
from ...models.search_customer_login_attempts_sort import SearchCustomerLoginAttemptsSort
...
def _get_kwargs(
    ...
    *,
    ...
    sort: Union[Unset, None, SearchCustomerLoginAttemptsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/customers/{customerId}/loginAttempts/success".format(client.api.value, customerId=customer_id)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchCustomerLoginAttemptsSort]):
