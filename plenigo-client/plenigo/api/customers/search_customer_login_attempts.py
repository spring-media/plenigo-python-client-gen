...
def _get_kwargs(
    ...
    *,
    ...
    sort: Union[Unset, SearchCustomerLoginAttemptsSort] = UNSET,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/customers/{customer_id}/loginAttempts/success",
        "params": params,
    }
...
def sync_all(
    ...
    *,
    ...
    all_results = CustomerLogInAttempt(items=[])  # type: ignore
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        sort (Union[Unset, SearchCustomerLoginAttemptsSort]):
