...
def _get_kwargs(
    ...
    *,
    ...
    sort: Union[Unset, SearchCustomerAppStoreSubscriptionsSort] = UNSET,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/customers/{customer_id}/appStoreSubscriptions",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        sort (Union[Unset, SearchCustomerAppStoreSubscriptionsSort]):
