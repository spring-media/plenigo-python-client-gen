...
from ...models.search_customer_foreign_orders_sort import SearchCustomerForeignOrdersSort
...
def _get_kwargs(
    ...
    *,
    ...
    sort: Union[Unset, None, SearchCustomerForeignOrdersSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/customers/{customerId}/foreignOrders".format(client.api.value, customerId=customer_id)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchCustomerForeignOrdersSort]):
