...
def _get_kwargs(
    ...
    *,
    ...
    sort: Union[Unset, None, SearchCustomerAddressesSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/customers/{customerId}/addresses".format(client.api.value, customerId=customer_id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Addresses, ErrorResultBase]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Addresses, ErrorResultBase]]:
    return Response(
...
def sync_all(
    ...
    *,
    ...
    all_results = Addresses(items=[])  # type: ignore
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchCustomerAddressesSort]):
