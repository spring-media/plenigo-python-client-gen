...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/customers/{customerId}/statusHistory".format(client.api.value, customerId=customer_id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[CustomerStatus, ErrorResultBase]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = CustomerStatus.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[CustomerStatus, ErrorResultBase]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    end_time: Union[Unset, None, datetime.datetime] = UNSET,
    starting_after: Union[Unset, None, str] = UNSET,
) -> Response[Union[CustomerStatus, ErrorResultBase]]:
...
def sync(
    ...
    *,
    ...
    end_time: Union[Unset, None, datetime.datetime] = UNSET,
    starting_after: Union[Unset, None, str] = UNSET,
) -> Optional[Union[CustomerStatus, ErrorResultBase]]:
    """Get customer status history
    ...
    Returns:
        Union[CustomerStatus, ErrorResultBase]
    """
