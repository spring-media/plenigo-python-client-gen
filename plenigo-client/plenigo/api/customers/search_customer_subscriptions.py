...
from ...models.search_customer_subscriptions_sort import SearchCustomerSubscriptionsSort
...
def _get_kwargs(
    ...
    *,
    ...
    sort: Union[Unset, None, SearchCustomerSubscriptionsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/customers/{customerId}/subscriptions".format(client.api.value, customerId=customer_id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorResultBase, Subscriptions]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorResultBase, Subscriptions]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Search customer's subscriptions
     ...
     Search all subscriptions that correspond to the given search conditions and belong to the customer
    identified by the customer id provided.
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchCustomerSubscriptionsSort]):
