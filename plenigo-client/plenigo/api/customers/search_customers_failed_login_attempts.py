...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchCustomersFailedLoginAttemptsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/customers/loginAttempts/failed".format(client.api.value)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchCustomersFailedLoginAttemptsSort]):
