...
from ...models.search_customers_failed_login_attempts_sort import SearchCustomersFailedLoginAttemptsSort
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, SearchCustomersFailedLoginAttemptsSort] = UNSET,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/customers/loginAttempts/failed",
        "params": params,
    }
...
def sync_all(
    *,
    ...
    all_results = FailedCustomerLogInAttempt(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (Union[Unset, SearchCustomersFailedLoginAttemptsSort]):
