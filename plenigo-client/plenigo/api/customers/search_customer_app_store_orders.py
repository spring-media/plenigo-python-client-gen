...
from ...models.search_customer_app_store_orders_sort import SearchCustomerAppStoreOrdersSort
...
def _get_kwargs(
    ...
    *,
    ...
    sort: Union[Unset, None, SearchCustomerAppStoreOrdersSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/customers/{customerId}/appStoreOrders".format(client.api.value, customerId=customer_id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[AppStoreOrders, ErrorResultBase]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[AppStoreOrders, ErrorResultBase]]:
    return Response(
...
def sync_all(
    ...
    *,
    ...
    all_results = AppStoreOrders(items=[])  # type: ignore
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchCustomerAppStoreOrdersSort]):
