...
from ...models.search_customer_invoices_sort import SearchCustomerInvoicesSort
...
def _get_kwargs(
    ...
    *,
    ...
    sort: Union[Unset, None, SearchCustomerInvoicesSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/customers/{customerId}/invoices".format(client.api.value, customerId=customer_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Search customer's invoices
     ...
     Search all invoices that correspond to the given search conditions and belong to the customer
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchCustomerInvoicesSort]):
