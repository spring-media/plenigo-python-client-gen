...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchCustomersLoginAttemptsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/customers/loginAttempts/success".format(client.api.value)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchCustomersLoginAttemptsSort]):
