...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchPayPalAccountsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/paymentMethods/payPalAccounts".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorResultBase, PayPalAccounts]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorResultBase, PayPalAccounts]]:
    return Response(
...
def sync_all(
    *,
    ...
    all_results = PayPalAccounts(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchPayPalAccountsSort]):
