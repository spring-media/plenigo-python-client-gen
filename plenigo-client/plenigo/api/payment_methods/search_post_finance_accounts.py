...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchPostFinanceAccountsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/paymentMethods/postFinanceAccounts".format(client.api.value)
...
) -> Optional[Union[ErrorResultBase, PostFinanceAccounts]]:
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[ErrorResultBase, PostFinanceAccounts]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchPostFinanceAccountsSort]):
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResultBase, PostFinanceAccounts]
    """
