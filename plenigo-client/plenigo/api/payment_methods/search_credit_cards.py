...
from ...models.search_credit_cards_sort import SearchCreditCardsSort
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchCreditCardsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/paymentMethods/creditCards".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[CreditCards, ErrorResultBase]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = CreditCards.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[CreditCards, ErrorResultBase]]:
    return Response(
...
def sync_all(
    *,
    ...
    ending_before: Union[Unset, None, str] = UNSET,
    sort: Union[Unset, None, SearchCreditCardsSort] = UNSET,
) -> Optional[Union[CreditCards, ErrorResultBase]]:
    all_results = CreditCards(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    ending_before: Union[Unset, None, str] = UNSET,
    sort: Union[Unset, None, SearchCreditCardsSort] = UNSET,
) -> Response[Union[CreditCards, ErrorResultBase]]:
    """Search credit card
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchCreditCardsSort]):
...
def sync(
    *,
    ...
    Returns:
        Union[CreditCards, ErrorResultBase]
    """
