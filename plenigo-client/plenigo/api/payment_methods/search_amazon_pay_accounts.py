...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchAmazonPayAccountsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/paymentMethods/amazonPayAccounts".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[AmazonPayAccounts, ErrorResultBase]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[AmazonPayAccounts, ErrorResultBase]]:
    return Response(
...
def sync_all(
    *,
    ...
    ending_before: Union[Unset, None, str] = UNSET,
    sort: Union[Unset, None, SearchAmazonPayAccountsSort] = UNSET,
) -> Optional[Union[AmazonPayAccounts, ErrorResultBase]]:
    all_results = AmazonPayAccounts(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    ending_before: Union[Unset, None, str] = UNSET,
    sort: Union[Unset, None, SearchAmazonPayAccountsSort] = UNSET,
) -> Response[Union[AmazonPayAccounts, ErrorResultBase]]:
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchAmazonPayAccountsSort]):
...
def sync(
    *,
    ...
    Returns:
        Union[AmazonPayAccounts, ErrorResultBase]
    """
