...
from ...models.search_twint_accounts_sort import SearchTwintAccountsSort
from ...models.twint_accounts import TwintAccounts
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchTwintAccountsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/paymentMethods/twintAccounts".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorResultBase, TwintAccounts]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = TwintAccounts.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorResultBase, TwintAccounts]]:
    return Response(
...
def sync_all(
    *,
    ...
    ending_before: Union[Unset, None, str] = UNSET,
    sort: Union[Unset, None, SearchTwintAccountsSort] = UNSET,
) -> Optional[Union[ErrorResultBase, TwintAccounts]]:
    all_results = TwintAccounts(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    ending_before: Union[Unset, None, str] = UNSET,
    sort: Union[Unset, None, SearchTwintAccountsSort] = UNSET,
) -> Response[Union[ErrorResultBase, TwintAccounts]]:
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchTwintAccountsSort]):
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResultBase, TwintAccounts]
    """
