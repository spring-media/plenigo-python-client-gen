...
def sync_detailed(
    ...
    *,
    ...
    """Delete a PostFinance account
     ...
     Delete a PostFinance account. This is only possible if PostFinance account is not associated with a
    subscription. Otherwise the subscription association must be
    removed first.
