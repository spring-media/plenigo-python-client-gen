...
from ...models.search_bank_accounts_sort import SearchBankAccountsSort
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchBankAccountsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/paymentMethods/bankAccounts".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[BankAccounts, ErrorResultBase]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = BankAccounts.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[BankAccounts, ErrorResultBase]]:
    return Response(
...
def sync_all(
    *,
    ...
    ending_before: Union[Unset, None, str] = UNSET,
    sort: Union[Unset, None, SearchBankAccountsSort] = UNSET,
) -> Optional[Union[BankAccounts, ErrorResultBase]]:
    all_results = BankAccounts(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    ending_before: Union[Unset, None, str] = UNSET,
    sort: Union[Unset, None, SearchBankAccountsSort] = UNSET,
) -> Response[Union[BankAccounts, ErrorResultBase]]:
    """Search bank account
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchBankAccountsSort]):
...
def sync(
    *,
    ...
    Returns:
        Union[BankAccounts, ErrorResultBase]
    """
