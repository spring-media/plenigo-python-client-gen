...
def _get_kwargs(
    *,
    ...
    plenigo_bonus_id: Union[Unset, None, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/products/bonuses".format(client.api.value)
    ...
    params["plenigoBonusId"] = plenigo_bonus_id
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Bonuses, ErrorResultBase]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Bonuses, ErrorResultBase]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        plenigo_bonus_id (Union[Unset, None, str]):
