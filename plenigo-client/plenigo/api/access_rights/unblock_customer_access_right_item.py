...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/accessRights/{customerId}/{accessRightUniqueId}/{itemId}/unblock".format(
        client.api.value, customerId=customer_id, accessRightUniqueId=access_right_unique_id, itemId=item_id
    )
