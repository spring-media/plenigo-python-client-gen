...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, SearchTransactionsSort] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (Union[Unset, SearchTransactionsSort]):
        plenigo_transaction_id (Union[Unset, str]):
        psp_transaction_id (Union[Unset, str]):
