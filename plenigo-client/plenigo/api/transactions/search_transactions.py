...
from ...models.search_transactions_sort import SearchTransactionsSort
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchTransactionsSort] = UNSET,
    plenigo_transaction_id: Union[Unset, None, str] = UNSET,
    psp_transaction_id: Union[Unset, None, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/transactions".format(client.api.value)
    ...
    params["plenigoTransactionId"] = plenigo_transaction_id

    params["pspTransactionId"] = psp_transaction_id
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorResultBase, Transactions]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorResultBase, Transactions]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchTransactionsSort]):
        plenigo_transaction_id (Union[Unset, None, str]):
        psp_transaction_id (Union[Unset, None, str]):
