...
from ...models.search_addresses_sort import SearchAddressesSort
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchAddressesSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/addresses".format(client.api.value)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchAddressesSort]):
