...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/addresses/{addressId}/futureAddresses".format(client.api.value, addressId=address_id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorResultBase, FutureAddresses]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorResultBase, FutureAddresses]]:
    return Response(
