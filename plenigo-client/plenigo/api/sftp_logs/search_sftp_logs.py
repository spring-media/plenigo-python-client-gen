...
from ...models.search_sftp_logs_sort import SearchSftpLogsSort
from ...models.sftp_log_entries import SftpLogEntries
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchSftpLogsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/sftp/logs".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorResultBase, SftpLogEntries]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = SftpLogEntries.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorResultBase, SftpLogEntries]]:
    return Response(
...
def sync_all(
    *,
    ...
    ending_before: Union[Unset, None, str] = UNSET,
    sort: Union[Unset, None, SearchSftpLogsSort] = UNSET,
) -> Optional[Union[ErrorResultBase, SftpLogEntries]]:
    all_results = SftpLogEntries(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    ending_before: Union[Unset, None, str] = UNSET,
    sort: Union[Unset, None, SearchSftpLogsSort] = UNSET,
) -> Response[Union[ErrorResultBase, SftpLogEntries]]:
    """Search
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchSftpLogsSort]):
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResultBase, SftpLogEntries]
    """
