...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/products/eventLists/{eventListId}".format(client.api.value, eventListId=event_list_id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorResultBase, EventListChange]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = EventListChange.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorResultBase, EventListChange]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Response[Union[ErrorResultBase, EventListChange]]:
    """Get

     Get event list that is identified by the passed event list id.
...
def sync(
    ...
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Optional[Union[ErrorResultBase, EventListChange]]:
    """Get
    ...
    Returns:
        Union[ErrorResultBase, EventListChange]
    """
