...
from ...models.event_lists import EventLists
...
def _get_kwargs(
    *,
    ...
    url = "{}/products/eventLists".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorResultBase, EventLists]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = EventLists.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorResultBase, EventLists]]:
    return Response(
...
def sync_all(
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Optional[Union[ErrorResultBase, EventLists]]:
    all_results = EventLists(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Response[Union[ErrorResultBase, EventLists]]:
    """Search

     Search all event lists that correspond to the given search conditions.
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResultBase, EventLists]
    """
