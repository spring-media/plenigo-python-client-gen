...
from ...models.event_list_dates import EventListDates
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/products/eventLists/{eventListId}/dates".format(client.api.value, eventListId=event_list_id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorResultBase, EventListDates]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = EventListDates.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorResultBase, EventListDates]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Response[Union[ErrorResultBase, EventListDates]]:
    """Get event dates

     Get event list dates that belong to the event list identified by the passed event list id.
...
def sync(
    ...
    *,
    ...
    starting_after: Union[Unset, None, str] = UNSET,
    ending_before: Union[Unset, None, str] = UNSET,
) -> Optional[Union[ErrorResultBase, EventListDates]]:
    """Get event dates
    ...
    Returns:
        Union[ErrorResultBase, EventListDates]
    """
