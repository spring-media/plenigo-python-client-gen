...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchProductMisuseRulesSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/products/misuseRules".format(client.api.value)
...
) -> Optional[Union[ErrorResultBase, ProductMisuseRules]]:
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[ErrorResultBase, ProductMisuseRules]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchProductMisuseRulesSort]):
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResultBase, ProductMisuseRules]
    """
