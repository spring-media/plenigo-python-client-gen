...
from ...models.delivery_list_change import DeliveryListChange
from ...models.error_result_base import ErrorResultBase
from ...models.get_delivery_list_sort import GetDeliveryListSort
...
def _get_kwargs(
    ...
    *,
    ...
    sort: Union[Unset, None, GetDeliveryListSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/products/deliveryLists/{deliveryListId}".format(client.api.value, deliveryListId=delivery_list_id)
...
) -> Optional[Union[DeliveryListChange, ErrorResultBase]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = DeliveryListChange.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[DeliveryListChange, ErrorResultBase]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        sort (Union[Unset, None, GetDeliveryListSort]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DeliveryListChange, ErrorResultBase]
    """
