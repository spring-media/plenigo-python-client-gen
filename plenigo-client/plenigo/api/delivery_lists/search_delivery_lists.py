...
from ...models.delivery_lists import DeliveryLists
from ...models.error_result_base import ErrorResultBase
from ...models.search_delivery_lists_sort import SearchDeliveryListsSort
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchDeliveryListsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/products/deliveryLists".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[DeliveryLists, ErrorResultBase]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = DeliveryLists.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[DeliveryLists, ErrorResultBase]]:
    return Response(
...
def sync_all(
    *,
    ...
    ending_before: Union[Unset, None, str] = UNSET,
    sort: Union[Unset, None, SearchDeliveryListsSort] = UNSET,
) -> Optional[Union[DeliveryLists, ErrorResultBase]]:
    all_results = DeliveryLists(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    ending_before: Union[Unset, None, str] = UNSET,
    sort: Union[Unset, None, SearchDeliveryListsSort] = UNSET,
) -> Response[Union[DeliveryLists, ErrorResultBase]]:
    """Search
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchDeliveryListsSort]):
...
def sync(
    *,
    ...
    Returns:
        Union[DeliveryLists, ErrorResultBase]
    """
