...
def _get_kwargs(
    *,
    ...
    size: int,
    sort: Union[Unset, None, GetOrderCreationStatisticsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/analytics/orders/creations".format(client.api.value)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        interval (GetOrderCreationStatisticsInterval):
        size (int):
        sort (Union[Unset, None, GetOrderCreationStatisticsSort]):
