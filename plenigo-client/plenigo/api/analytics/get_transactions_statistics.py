...
def _get_kwargs(
    *,
    ...
    size: int,
    sort: Union[Unset, None, GetTransactionsStatisticsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/analytics/transactions".format(client.api.value)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        interval (GetTransactionsStatisticsInterval):
        size (int):
        sort (Union[Unset, None, GetTransactionsStatisticsSort]):
