...
from ...models.get_active_subscriptions_interval import GetActiveSubscriptionsInterval
from ...models.get_active_subscriptions_sort import GetActiveSubscriptionsSort
...
def _get_kwargs(
    *,
    ...
    interval: GetActiveSubscriptionsInterval,
    size: int,
    sort: Union[Unset, None, GetActiveSubscriptionsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/analytics/subscriptions/active".format(client.api.value)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        interval (GetActiveSubscriptionsInterval):
        size (int):
        sort (Union[Unset, None, GetActiveSubscriptionsSort]):
