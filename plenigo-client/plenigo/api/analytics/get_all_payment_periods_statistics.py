...
from ...models.get_all_payment_periods_statistics_interval import GetAllPaymentPeriodsStatisticsInterval
from ...models.get_all_payment_periods_statistics_sort import GetAllPaymentPeriodsStatisticsSort
...
def _get_kwargs(
    *,
    ...
    interval: GetAllPaymentPeriodsStatisticsInterval,
    size: int,
    sort: Union[Unset, None, GetAllPaymentPeriodsStatisticsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/analytics/subscriptions/paymentPeriods".format(client.api.value)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        interval (GetAllPaymentPeriodsStatisticsInterval):
        size (int):
        sort (Union[Unset, None, GetAllPaymentPeriodsStatisticsSort]):
