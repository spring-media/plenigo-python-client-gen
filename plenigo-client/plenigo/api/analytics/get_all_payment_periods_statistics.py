...
def _get_kwargs(
    *,
    ...
    size: int,
    sort: Union[Unset, GetAllPaymentPeriodsStatisticsSort] = UNSET,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/analytics/subscriptions/paymentPeriods",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        interval (GetAllPaymentPeriodsStatisticsInterval):
        size (int):
        sort (Union[Unset, GetAllPaymentPeriodsStatisticsSort]):
