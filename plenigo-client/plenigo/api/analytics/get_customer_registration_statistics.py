...
from ...models.get_customer_registration_statistics_interval import GetCustomerRegistrationStatisticsInterval
from ...models.get_customer_registration_statistics_sort import GetCustomerRegistrationStatisticsSort
...
def _get_kwargs(
    *,
    ...
    interval: GetCustomerRegistrationStatisticsInterval,
    size: int,
    sort: Union[Unset, None, GetCustomerRegistrationStatisticsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/analytics/customers/registrations".format(client.api.value)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        interval (GetCustomerRegistrationStatisticsInterval):
        size (int):
        sort (Union[Unset, None, GetCustomerRegistrationStatisticsSort]):
