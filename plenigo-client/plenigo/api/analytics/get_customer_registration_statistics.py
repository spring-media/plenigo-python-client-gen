...
def _get_kwargs(
    *,
    ...
    size: int,
    sort: Union[Unset, GetCustomerRegistrationStatisticsSort] = UNSET,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/analytics/customers/registrations",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        interval (GetCustomerRegistrationStatisticsInterval):
        size (int):
        sort (Union[Unset, GetCustomerRegistrationStatisticsSort]):
