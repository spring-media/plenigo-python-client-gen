...
from ...models.get_cancelled_subscriptions_interval import GetCancelledSubscriptionsInterval
from ...models.get_cancelled_subscriptions_sort import GetCancelledSubscriptionsSort
...
def _get_kwargs(
    *,
    ...
    interval: GetCancelledSubscriptionsInterval,
    size: int,
    sort: Union[Unset, None, GetCancelledSubscriptionsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/analytics/subscriptions/cancellations".format(client.api.value)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        interval (GetCancelledSubscriptionsInterval):
        size (int):
        sort (Union[Unset, None, GetCancelledSubscriptionsSort]):
