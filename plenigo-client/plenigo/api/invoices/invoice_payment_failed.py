...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/invoices/{invoiceId}/paymentFailed".format(client.api.value, invoiceId=invoice_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Invoice payment failed
     ...
     Handle invoice payment failed for an invoice paid via billing - this must be triggered by the system
