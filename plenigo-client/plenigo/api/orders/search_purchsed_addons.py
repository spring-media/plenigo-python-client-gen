...
def _get_kwargs(
    *,
    ...
    url = "{}/orders/purchasedAddons".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorResultBase, PurchasedAddons]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorResultBase, PurchasedAddons]]:
    return Response(
