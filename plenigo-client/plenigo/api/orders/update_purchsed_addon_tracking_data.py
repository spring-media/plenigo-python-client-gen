...
def _get_kwargs(
    ...
    *,
    ...
    json_body: UpdateAddonTrackingData,
) -> Dict[str, Any]:
    url = "{}/orders/purchasedAddons/{purchasedAddonId}/trackingData".format(
        client.api.value, purchasedAddonId=purchased_addon_id
    )
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorResultBase, PurchasedAddon]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorResultBase, PurchasedAddon]]:
    return Response(
