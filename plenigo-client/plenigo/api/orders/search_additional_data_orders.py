...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchAdditionalDataOrdersSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/orders/additionalData".format(client.api.value)
...
) -> Optional[Union[AdditionalOrderDataList, ErrorResultBase]]:
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[AdditionalOrderDataList, ErrorResultBase]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchAdditionalDataOrdersSort]):
...
def sync(
    *,
    ...
    Returns:
        Union[AdditionalOrderDataList, ErrorResultBase]
    """
