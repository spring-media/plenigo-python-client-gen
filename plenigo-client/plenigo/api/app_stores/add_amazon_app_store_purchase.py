...
from ...models.amazon_app_store_purchase_addition import AmazonAppStorePurchaseAddition
...
def _get_kwargs(
    *,
    ...
    json_body: AmazonAppStorePurchaseAddition,
) -> Dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Add Amazon purchase
     ...
     Add an Amazon app store purchase to the plenigo system and retrieve a token for further processing.
