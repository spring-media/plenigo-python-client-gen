...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchAppStoreSubscriptionsSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/appStores/subscriptions".format(client.api.value)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchAppStoreSubscriptionsSort]):
