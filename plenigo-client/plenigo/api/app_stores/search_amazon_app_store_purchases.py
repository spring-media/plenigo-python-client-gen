...
from ...models.amazon_app_store_purchases import AmazonAppStorePurchases
from ...models.error_result_base import ErrorResultBase
from ...models.search_amazon_app_store_purchases_sort import SearchAmazonAppStorePurchasesSort
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchAmazonAppStorePurchasesSort] = UNSET,
    token: Union[Unset, None, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/appStores/amazonAppStore".format(client.api.value)
...
) -> Optional[Union[AmazonAppStorePurchases, ErrorResultBase]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = AmazonAppStorePurchases.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[AmazonAppStorePurchases, ErrorResultBase]]:
    return Response(
...
def sync_all(
    *,
    ...
    all_results = AmazonAppStorePurchases(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    """Search Amazon purchases

     Search all Amazon purchases that correspond to the given search conditions.
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchAmazonAppStorePurchasesSort]):
...
def sync(
    *,
    ...
    Returns:
        Union[AmazonAppStorePurchases, ErrorResultBase]
    """
