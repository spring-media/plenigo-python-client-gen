...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/appStores/amazonAppStore/{token}/associate".format(client.api.value, token=token)
...
def sync_detailed(
    ...
    *,
    ...
    """Associate Amazon purchase

     Associate an Amazon app store purchase with a customer.
