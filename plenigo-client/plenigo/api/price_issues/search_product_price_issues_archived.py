...
from ...models.search_product_price_issues_archived_sort import SearchProductPriceIssuesArchivedSort
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, SearchProductPriceIssuesArchivedSort] = UNSET,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/products/priceIssues/archived",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (Union[Unset, SearchProductPriceIssuesArchivedSort]):
