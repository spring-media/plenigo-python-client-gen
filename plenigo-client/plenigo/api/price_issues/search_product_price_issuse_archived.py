...
from ...models.search_product_price_issuse_archived_sort import SearchProductPriceIssuseArchivedSort
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, None, SearchProductPriceIssuseArchivedSort] = UNSET,
) -> Dict[str, Any]:
    url = "{}/products/priceIssues/archived".format(client.api.value)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorResultBase, PriceIssues]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorResultBase, PriceIssues]]:
    return Response(
...
def sync_all(
    *,
    ...
    all_results = PriceIssues(items=[])  # type: ignore
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (Union[Unset, None, SearchProductPriceIssuseArchivedSort]):
