...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[BlockedIbans, ErrorResultBase]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[BlockedIbans, ErrorResultBase]]:
    return Response(
