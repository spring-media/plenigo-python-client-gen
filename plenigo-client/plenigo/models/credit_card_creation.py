...
T = TypeVar("T", bound="CreditCardCreation")


@_attrs_define
class CreditCardCreation:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        credit_card_creation.additional_properties = d
        return credit_card_creation
