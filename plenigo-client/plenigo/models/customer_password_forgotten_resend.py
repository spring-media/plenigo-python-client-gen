...
T = TypeVar("T", bound="CustomerPasswordForgottenResend")


@attr.s(auto_attribs=True)
class CustomerPasswordForgottenResend:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        customer_password_forgotten_resend = cls(
            token=token,
            os=os,
            browser=browser,
            source=source,
        ...
        customer_password_forgotten_resend.additional_properties = d
        return customer_password_forgotten_resend
