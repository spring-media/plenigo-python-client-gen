...
T = TypeVar("T", bound="FutureAddress")
...
class FutureAddress:
    ...
    Attributes:
        ...
        activation_date (Union[None, Unset, datetime.datetime]): date the future address entity will get the active
            address with date notation as defined for example, 2017-07-21
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        future_address.additional_properties = d
