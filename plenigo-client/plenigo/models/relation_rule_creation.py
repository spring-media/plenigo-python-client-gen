...
T = TypeVar("T", bound="RelationRuleCreation")


@_attrs_define
class RelationRuleCreation:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        relation_rule_creation.additional_properties = d
        return relation_rule_creation
