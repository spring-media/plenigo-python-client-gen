...
T = TypeVar("T", bound="PostFinanceAccount")


@_attrs_define
class PostFinanceAccount:
    """
    Attributes:
        charge_permission_id (str): the PostFinance charge permission id
        post_finance_account_id (int): unique id of the PostFinance account
        ...
        active (Union[Unset, bool]): flag indicating if PostFinance account is active - a PostFinance account can become
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        post_finance_account_id = self.post_finance_account_id
        ...
        field_dict.update(
            {
                ...
                "postFinanceAccountId": post_finance_account_id,
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_finance_account_id = d.pop("postFinanceAccountId")
        ...
        post_finance_account.additional_properties = d
        return post_finance_account
