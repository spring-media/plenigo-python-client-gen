...
from ..models.subscription_statuss_new_status import SubscriptionStatussNewStatus
from ..models.subscription_statuss_old_status import SubscriptionStatussOldStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="SubscriptionStatuss")
...
class SubscriptionStatuss:
    ...
    Attributes:
        ...
        chain_id (Union[Unset, int]): all subscriptions that are in one chain because of some rules or cross selling
            ...
            within the chain
        old_status (Union[Unset, SubscriptionStatussOldStatus]): old status
        new_status (Union[Unset, SubscriptionStatussNewStatus]): current status
    """
    ...
    old_status: Union[Unset, SubscriptionStatussOldStatus] = UNSET
    new_status: Union[Unset, SubscriptionStatussNewStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        old_status: Union[Unset, SubscriptionStatussOldStatus]
        if isinstance(_old_status, Unset):
            old_status = UNSET
        else:
            old_status = SubscriptionStatussOldStatus(_old_status)

        _new_status = d.pop("newStatus", UNSET)
        new_status: Union[Unset, SubscriptionStatussNewStatus]
        if isinstance(_new_status, Unset):
            new_status = UNSET
        else:
            new_status = SubscriptionStatussNewStatus(_new_status)

        subscription_statuss = cls(
        ...
        subscription_statuss.additional_properties = d
        return subscription_statuss
