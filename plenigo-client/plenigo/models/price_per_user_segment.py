...
T = TypeVar("T", bound="PricePerUserSegment")


@_attrs_define
class PricePerUserSegment:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        price_per_user_segment = cls(
            from_user_count=from_user_count,
            price_issue_id=price_issue_id,
        )

        price_per_user_segment.additional_properties = d
        return price_per_user_segment
