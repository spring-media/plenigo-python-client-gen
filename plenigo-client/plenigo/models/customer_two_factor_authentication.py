...
T = TypeVar("T", bound="CustomerTwoFactorAuthentication")


@attr.s(auto_attribs=True)
class CustomerTwoFactorAuthentication:
    """
    Attributes:
        token (str): The token to validate the step.
        two_factor_token (str): two factor token to verify login
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        customer_two_factor_authentication = cls(
            token=token,
        ...
        customer_two_factor_authentication.additional_properties = d
        return customer_two_factor_authentication
