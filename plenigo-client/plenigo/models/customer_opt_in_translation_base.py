...
T = TypeVar("T", bound="CustomerOptInTranslationBase")


@_attrs_define
class CustomerOptInTranslationBase:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        customer_opt_in_translation_base = cls(
            language=language,
            sso_text=sso_text,
        ...
        customer_opt_in_translation_base.additional_properties = d
        return customer_opt_in_translation_base
