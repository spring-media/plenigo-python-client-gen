...
T = TypeVar("T", bound="CrossOfferProductGroup")


@_attrs_define
class CrossOfferProductGroup:
    """
    Attributes:
        ...
        products (List['CrossOfferProduct']): products associated with this product group
    ...
    products: List["CrossOfferProduct"]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        cross_offer_product_group.additional_properties = d
        return cross_offer_product_group
