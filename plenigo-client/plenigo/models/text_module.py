...
class TextModule:
    ...
    Attributes:
        ...
        text_module_id (int): unique id of the text module
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        text_module_id = self.text_module_id
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        text_module_id = d.pop("textModuleId")
        ...
        text_module.additional_properties = d
        return text_module
