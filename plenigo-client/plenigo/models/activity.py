...
class Activity:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_activity_type, Unset) or not _activity_type:
            activity_type = UNSET
        else:
        ...
        if isinstance(_json_object_type, Unset) or not _json_object_type:
        ...
        if isinstance(_old_object, Unset) or not _old_object:
            old_object = UNSET
        else:
        ...
        if isinstance(_new_object, Unset) or not _new_object:
            new_object = UNSET
        else:
        ...
        if isinstance(_reason, Unset) or not _reason:
            reason = UNSET
        else:
