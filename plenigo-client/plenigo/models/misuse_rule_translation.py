...
T = TypeVar("T", bound="MisuseRuleTranslation")


@_attrs_define
class MisuseRuleTranslation:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        misuse_rule_translation.additional_properties = d
        return misuse_rule_translation
