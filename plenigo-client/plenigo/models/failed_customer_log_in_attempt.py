...
T = TypeVar("T", bound="FailedCustomerLogInAttempt")


@_attrs_define
class FailedCustomerLogInAttempt:
    """
    Attributes:
        ...
        failed_customer_log_in_id (Union[Unset, int]): technical id of the customer log in
    """
    ...
    failed_customer_log_in_id: Union[Unset, int] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        failed_customer_log_in_id = self.failed_customer_log_in_id
        ...
        if failed_customer_log_in_id is not UNSET:
            field_dict["failedCustomerLogInId"] = failed_customer_log_in_id
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        failed_customer_log_in_id = d.pop("failedCustomerLogInId", UNSET)

        failed_customer_log_in_attempt = cls(
            ...
            country=country,
            failed_customer_log_in_id=failed_customer_log_in_id,
        )

        failed_customer_log_in_attempt.additional_properties = d
        return failed_customer_log_in_attempt
