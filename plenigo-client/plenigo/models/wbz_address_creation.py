...
T = TypeVar("T", bound="WbzAddressCreation")


@_attrs_define
class WbzAddressCreation:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        wbz_address_creation.additional_properties = d
        return wbz_address_creation
