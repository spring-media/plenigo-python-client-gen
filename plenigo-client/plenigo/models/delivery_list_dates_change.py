...
T = TypeVar("T", bound="DeliveryListDatesChange")


@_attrs_define
class DeliveryListDatesChange:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        delivery_list_dates_change = cls(
            title=title,
        ...
        delivery_list_dates_change.additional_properties = d
        return delivery_list_dates_change
