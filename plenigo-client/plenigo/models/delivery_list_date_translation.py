...
T = TypeVar("T", bound="DeliveryListDateTranslation")


@_attrs_define
class DeliveryListDateTranslation:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        delivery_list_date_translation = cls(
            language=language,
            title=title,
        ...
        delivery_list_date_translation.additional_properties = d
        return delivery_list_date_translation
