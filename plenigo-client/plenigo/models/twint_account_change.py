...
T = TypeVar("T", bound="TwintAccountChange")


@_attrs_define
class TwintAccountChange:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        twint_account_change = cls(
            charge_permission_id=charge_permission_id,
            preferred=preferred,
            invalid=invalid,
        )

        twint_account_change.additional_properties = d
        return twint_account_change
