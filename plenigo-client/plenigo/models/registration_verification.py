...
T = TypeVar("T", bound="RegistrationVerification")
...
class RegistrationVerification:
    ...
    Attributes:
        ...
        verification_token (str): token to verify registration
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        registration_verification.additional_properties = d
