...
from ..models.subscription_status_new_status import SubscriptionStatusNewStatus
from ..models.subscription_status_old_status import SubscriptionStatusOldStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="SubscriptionStatus")
...
class SubscriptionStatus:
    ...
    Attributes:
        ...
        chain_id (Union[Unset, int]): all subscriptions that are in one chain because of some rules or cross selling
            ...
            within the chain
        old_status (Union[Unset, SubscriptionStatusOldStatus]): old status
        new_status (Union[Unset, SubscriptionStatusNewStatus]): current status
    """
    ...
    old_status: Union[Unset, SubscriptionStatusOldStatus] = UNSET
    new_status: Union[Unset, SubscriptionStatusNewStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        old_status: Union[Unset, SubscriptionStatusOldStatus]
        if isinstance(_old_status, Unset):
            old_status = UNSET
        else:
            old_status = SubscriptionStatusOldStatus(_old_status)

        _new_status = d.pop("newStatus", UNSET)
        new_status: Union[Unset, SubscriptionStatusNewStatus]
        if isinstance(_new_status, Unset):
            new_status = UNSET
        else:
            new_status = SubscriptionStatusNewStatus(_new_status)

        subscription_status = cls(
        ...
        subscription_status.additional_properties = d
