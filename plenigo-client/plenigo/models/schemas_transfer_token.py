...
T = TypeVar("T", bound="SchemasTransferToken")


@_attrs_define
class SchemasTransferToken:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        schemas_transfer_token = cls(
            transfer_token=transfer_token,
        )

        schemas_transfer_token.additional_properties = d
        return schemas_transfer_token
