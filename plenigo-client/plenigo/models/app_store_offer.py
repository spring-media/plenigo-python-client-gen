...
T = TypeVar("T", bound="AppStoreOffer")
...
class AppStoreOffer:
    ...
    Attributes:
        ...
        app_store_offer_id (int): unique id of the app store offer within a contract company
        ...
        archived (Union[Unset, bool]): flag indicating if app store offer is archived
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        app_store_offer_id = self.app_store_offer_id
        ...
        field_dict.update(
            {
                ...
                "appStoreOfferId": app_store_offer_id,
            }
        )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        app_store_offer_id = d.pop("appStoreOfferId")
        ...
        app_store_offer.additional_properties = d
        return app_store_offer
