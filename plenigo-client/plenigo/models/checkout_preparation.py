...
class CheckoutPreparation:
    ...
    Attributes:
        ...
        external_basket_id (Union[Unset, str]): external basket identifier
        ...
        items (Union[Unset, List['CheckoutOffer']]): checkout conditions that must be checked before checkout can start
    """
    ...
    external_basket_id: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        external_basket_id = self.external_basket_id
        ...
        if external_basket_id is not UNSET:
            field_dict["externalBasketId"] = external_basket_id
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        external_basket_id = d.pop("externalBasketId", UNSET)
        ...
        checkout_preparation = cls(
            ...
            basket_id=basket_id,
            external_basket_id=external_basket_id,
