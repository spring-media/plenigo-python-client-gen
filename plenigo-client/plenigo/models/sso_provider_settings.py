...
if TYPE_CHECKING:
    from ..models.sso_provider_settings_google_settings import SsoProviderSettingsGoogleSettings
...
class SsoProviderSettings:
    ...
    Attributes:
        ...
        google_settings (Union[Unset, SsoProviderSettingsGoogleSettings]): google SSO settings
    """
    ...
    google_settings: Union[Unset, "SsoProviderSettingsGoogleSettings"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        google_settings: Union[Unset, SsoProviderSettingsGoogleSettings]
        if isinstance(_google_settings, Unset) or not _google_settings:
            google_settings = UNSET
        else:
            google_settings = SsoProviderSettingsGoogleSettings.from_dict(_google_settings)
