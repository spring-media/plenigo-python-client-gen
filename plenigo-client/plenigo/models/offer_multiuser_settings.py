...
T = TypeVar("T", bound="OfferMultiuserSettings")


@_attrs_define
class OfferMultiuserSettings:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        offer_multiuser_settings = cls(
            only_bundled_usage=only_bundled_usage,
            invitation_validity_in_days=invitation_validity_in_days,
            invitation_url=invitation_url,
        )

        offer_multiuser_settings.additional_properties = d
        return offer_multiuser_settings
