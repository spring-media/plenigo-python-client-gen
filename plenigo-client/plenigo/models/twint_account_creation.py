...
T = TypeVar("T", bound="TwintAccountCreation")


@_attrs_define
class TwintAccountCreation:
    """
    Attributes:
        ...
        created_at (Union[None, Unset, datetime.datetime]): date time the Twint account entity was created with date-
        ...
        updated_at (Union[None, Unset, datetime.datetime]): date time the Twint account entity was changed with date-
            time notation as defined by <a href="https://tools.ietf.org/html/rfc3339#section-5.6" target="_blank">RFC 3339,
            section 5.6</a>, for example, 2017-07-21T17:32:28Z
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        twint_account_creation.additional_properties = d
        return twint_account_creation
