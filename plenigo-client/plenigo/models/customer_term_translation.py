...
T = TypeVar("T", bound="CustomerTermTranslation")


@_attrs_define
class CustomerTermTranslation:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        customer_term_translation.additional_properties = d
        return customer_term_translation
